...
const myQuestion = new Question("What is the name of a baby penguin?", ["chicks", "kitten"], "Puppy");
const userAnswer = "chicks";
console.log(myQuestion.checkAnswer(userAnswer)); 
